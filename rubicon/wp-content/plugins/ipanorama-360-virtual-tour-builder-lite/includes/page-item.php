	...
	<div class="ipanorama-app" id="ipanorama-app">
		...
		<div class="ipanorama-wrap">
			...
			<div class="ipanorama-workplace">
				<div id="ipanorama-view" class="ipanorama-view">
				</div>
				...
				<div class="ipanorama-main-tabs ipanorama-clear-fix">
					...
					<div class="ipanorama-tab" al-attr.class.ipanorama-active="appData.ui.tabs.shapes" al-on.click="appData.fn.onTab(appData, 'shapes')" al-if="appData.ui.activeScene != null"><?php esc_html_e('Shapes', IPANORAMA_PLUGIN_NAME); ?><div class="ipanorama-counter" al-if="appData.ui.activeScene.shapes.length>0">{{appData.ui.activeScene.shapes.length}}</div></div>
										...
										<div class="ipanorama-block-data">
											<div class="ipanorama-control">
												...
												<div class="ipanorama-input-group">
													...
													<div class="ipanorama-input-group-cell">
														<?php esc_html_e('Do not fire the progress event when loading the original image', IPANORAMA_PLUGIN_NAME); ?>
													</div>
												</div>
											</div>

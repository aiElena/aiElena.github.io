...
class currency_switcherWcu extends moduleWcu
{
    ...
    public function drawModule($previewOptions = array()) {
        ...
        if (isset($show) && $show) {
            return $this->getView()->getCurrencySwitcher($previewOptions);
        }
		return '';
    }
    public function getDefaultOptions() {
        return array(
            ...
            'display_rules_tab' => array(
				...
				'switcher_shortcode' => '<code>[woo-currency-switcher]</code>',
				'switcher_shortcode_php' => '<code>'.htmlentities("<?php echo do_shortcode('[woo-currency-switcher]')?>").'</code>',

...
<div id="wcuCurrencySwitcherSimpleDropdown" class="wcuCurrencySwitcher <?php echo $side_simple?> <?php echo $layout?> wcuCsdShow_<?php echo $show?> wcuCsdToggleSwitcher_<?php echo $toggle_switcher?> wcuCsdIconType_<?php echo $icon_type?> wcuCsdIconSize_<?php echo $icon_size?> wcuCsdShowBorder_<?php echo $show_border?>" data-type="<?php echo $type?>" style="display: none;">
	<ul>

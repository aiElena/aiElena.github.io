...
class currencyViewWcu extends viewWcu {
	...
	public function getCurrencyTabContent() {
		...
		//$this->assign('tabs', dispatcherWcu::applyFilters('currencyTabs', array()));
		parent::display('currencyTabContent');
	}

	// public function getCurrenciesTabContent() {
	// 	return parent::getContent('currenciesTab');
	// }
	//
	// public function getOptionsContent() {
	// 	return parent::getContent('optionsTab');
	// }
	//
	// public function getDesignContent() {
	// 	return parent::getContent('designTab');
	// }
	//
	// public function getCustomCssContent() {
	// 	return parent::getContent('customCssTab');
	// }

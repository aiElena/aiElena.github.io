...
WooCommerce Currency Switcher allows customers to switch products prices to any currencies. Get rates converted in the real-time with dynamic currency switcher

== Description ==
[WooCommerce Currency Switcher Plugin](https://woobewoo.com/plugins/woo-currency?utm_source=wordpress&utm_medium=description&utm_campaign=currency "WooCommerce Currency Switcher WordPress plugin") allows you to display prices in multiple currencies, use the unlimited number of currencies and set the exchange rate for each currency manually or automatically. The plugin makes full use of Cryptocompare and Free Converter platforms, providing the latest exchange rates, and substitute displayed prices in real time. Currency can be changed automatically according to the customer’s IP.

You can use Currency Switcher with additional modules - [Currency Rates, Converter and Tooltip modes](https://woobewoo.com/feature/rates-converter-tooltip-modes/ "Rates, converter, tooltip modes"). This will grant your customers the possibility of shopping in their favourite currency, thus increasing store selling. The best currency switcher to make an online store in multiple currencies!
...
You can convert any currency you require and add as many currencies as you need. Select the currency from a list and with simple settings add it to the Currency switcher straight away to your online store.
...
Currency switcher uses Cryptocompare and Free Converter aggregatots. Plugin allows setting to exchange rates manually and automatically. Also, in the Pro version an Automatic exchange rate updates available for a certain period: every minute, hourly, twice a day, daily, weekly. You can set the option “Notice admin by email” about the last exchange rates value every time then it updates.

* [Checkout in selected currency](https://woobewoo.com/documentation/change-currency-at-checkout/ "Checkout in selected currency")
Plugin provides an opportunity to change the currency at checkout and allow customers to pay in their selected (preferred) currency.
This feature is perfect for WooCommerce shops with a shop currency not in this list: “AUD, BRL, CAD, CZK, DKK, EUR, HKD, HUF, ILS, JPY, MYR, MXN, NOK, NZD, PHP, PLN, GBP, SGD, SEK, CHF, TWD, THB, USD”, or want to convert into a different PayPal currency to avoid conversion fees by PayPal.
...
Set the Base currency, Name, Title, Symbol, Position, Cents, Rate. Put rate manually or press the Get Rate button in one click.
...
With Currency Plugin, you can make the Currency Switcher not only functional but beautifully designed too. Simple, Rotating, Floating types of a switcher. Position, Color settings for all elements of switcher easily make it unique and fit the design of the store.
...
WooCommerce Currency Switcher works great with any WordPress theme. Plugins are being tested at least on 4 testing servers before each release.
...
The plugin comes with three additional modes– tooltip, currency rates and currency converter. These modes enable the user to display the rate also convert it simultaneously and see the tooltip with a price cost of the product compare to the other currencies. You have the ability to customize and set their display matching the theme of your store and easily place them on the pages, product categories and custom post types.
* [Encrease the cart conversion](https://woobewoo.com/feature/shopping-cart-conversion-rate?utm_source=wordpress&utm_medium=cartconversion&utm_campaign=currency "Shopping cart conversion rate")
Store conversion rates could be improved up to 30% if to allow the customers to see the prices in a preferred currency. You don’t lose customers just because they don’t have the option to pay in their native currency.
* [Geo IP rules](https://woobewoo.com/feature/geo-ip-rules "Geo IP rules")**
When Geo IP rules feature enabled, Currencies Switcher will automatically detect your customers’ countries by their IP address and they will see products in their country’s currency. Also, using custom settings you are able to specify the definition of the currency yourself, just select your list of countries for each currency. 
* [Mobile Friendly](https://woobewoo.com/feature/mobile-friendly/ "Mobile Friendly")
 With our plugin, you can have two versions of currency switcher, rates and converter for your website ready to go – one for mobile, one for desktops and laptops. The plugin automatically detects the device accessing your website and then automatically display a mobile-optimized version to the user. You can choose the devices to display modules: mobile, desktops or both. An added bonus is the ability to choose at what size screen your site will be displayed as mobile.
 
 ** - Pro features


= Support and suggestions for WooCommerce Currency Plugin =
...
Video tutorial how to set up  WooCommerce Currency Switcher Plugin by Woobewoo
...
Type "WooCommerce Currency Plugin by Woobewoo" in the search field
...
Follow this tutorial [Getting Started with WooCommerce Currency Switcher plugin](https://woobewoo.com/documentation/getting-started-with-woocommerce-currency-plugin?utm_source=wordpress&utm_medium=GettingStarted&utm_campaign=currency "Getting Started with WooCommerce Currency Switcher plugin") for more detailed instructions.

= I've installed your WooCommerce Currency Switcher, but can't find see the plugin configuration =

WooCommerce Currency Switcher plugin created special tab Currency in the WooCommerce Settings menu. You can follow the link in plugin window to move there, or go there manually via WooCommerce plugin. Follow this tutorial [Main Settings](https://woobewoo.com/documentation/currency-main-settings?utm_source=wordpress&utm_medium=main-settings&utm_campaign=currency "Main Settings") and you can easily set the Currency Switcher plugin.
...
Large or small, desktop or handheld, WooCommerce Currency Switcher is fully compatible and responsive! The plugin works and displays perfectly on tablet or phone, making it easy and convenient for customers to enjoy their shopping time and make purchases on all devices.
...
3. WooCommerce Currency Switcher Plugin admin panel. Currencies settings
4. WooCommerce Currency Switcher Plugin admin panel. Options 

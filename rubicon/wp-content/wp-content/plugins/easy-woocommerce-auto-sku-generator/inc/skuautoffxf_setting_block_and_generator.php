		...
		<div id="postbox-container-2" class="postbox-container postbox">
				<div class="meta-box-sortables">
					...
					<span class="dashicons dashicons-admin-generic my_generic_two"></span>
							...
							<hr>
							<div class="mass_generate">
								<div><i class="woocommerce-help-tip" data-tip="<?php echo __( 'The function is under development and will most likely be available in paid versions.', 'easy-woocommerce-auto-sku-generator' ); ?>"></i> <?php echo __( 'Bulk generate SKU by Category', 'easy-woocommerce-auto-sku-generator' ); ?></div>
								<div><button name="save" class="button-primary woocommerce-save-button disabled" disabled><?php echo __( 'Generate by Category', 'easy-woocommerce-auto-sku-generator' ); ?></button></div>
							</div>
							<hr>
							<div class="mass_generate">
				...
				<div class="meta-box-sortables">
					...
					<span class="dashicons dashicons-chart-pie"></span>
							...
							<div class="recomendated_plugin_block">
								...
								<div>
								<a href="/wp-admin/plugin-install.php?tab=plugin-information&amp;plugin=art-woocommerce-order-one-click&amp;TB_iframe=true&amp;width=772&amp;height=468" class="thickbox open-plugin-details-modal" aria-label="Art WooCommerce Order One Click" data-title="Art WooCommerce Order One Click"><h4><?php echo __( 'Art WooCommerce Order One Click', 'easy-woocommerce-auto-sku-generator' ); ?></h4></a>
								</div>
							</div>
							<hr>
							<div class="recomendated_plugin_block">
								...
								<div>
								<a href="/wp-admin/plugin-install.php?tab=plugin-information&amp;plugin=luckywp-scripts-control&amp;TB_iframe=true&amp;width=600&amp;height=550" class="thickbox open-plugin-details-modal" aria-label="LuckyWP Scripts Control" data-title="LuckyWP Scripts Control"><h4><?php echo __( 'LuckyWP Scripts Control', 'easy-woocommerce-auto-sku-generator' ); ?></h4></a>
								</div>
							</div>
						</div>
					</div>
...
function skuautoffxf_modal_setting() {
	if ( isset( $_GET['section'] ) && $_GET['section'] === 'skuautoffxf' ) { ?>
        <div class="modal-frame modal_generate">
            <div class="modal">

...
FFxF_el.innerHTML =
    '<a target="_blank" data-tooltip="Settings SKU" data-tooltip-bottom="" href="/wp-admin/admin.php?page=wc-settings&tab=products&section=skuautoffxf">' +
...
function FFxF_makeid_reflesh() {
    ...
    var FFxF_random_sku = FFxF_makeid(ffxf_slug.skuautoffxf_auto_number);

...
if (!function_exists('woof_show_btn')) {
    function woof_show_btn($autosubmit=1,$ajax_redraw=0){
        ...
        <div class="woof_submit_search_form_container">
            ...
            <?php
            global $WOOF;
            if ($WOOF->is_isset_in_request_data($WOOF->get_swoof_search_slug()) OR class_exists("WOOF_EXT_TURBO_MODE")  ): global $woof_link; ?>
            ...
            <?php if (!$autosubmit OR $ajax_redraw): ?>
                ...
                ?>
                    <button style="float: left;" class="button woof_submit_search_form">Поиск</button>
            <?php endif; ?>

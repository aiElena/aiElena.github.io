...
<?php get_header();?>
	...
	<div class="row">
		<div class="grid-test col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
			<div class="lamp">
				<span class="h1"><button type="button" class="button_1">Автоматизация QA</button></span>			
				<h1>Автоматизация<br> QA</h1>
		...
		<div class="grid-test col-lg-5 col-md-5 col-sm-5 col-xs-5 h5 text-right txt left">	
			...
			<div class="line_1"></div>
			<p>
				RubyMine — Productive Guide
			</p>
			<div class="line_1"></div>
			<p>
				REST and SOAP testing basics
			</p>
			<div class="line_1"></div>
		</div>	
		...
		<div class="grid-test col-lg-5 col-md-5 col-sm-5 col-xs-5 h5 txt right">
			...
			<div class="line_2"></div>
			<p>
				Jenkins как Система Непрерывной интеграции 

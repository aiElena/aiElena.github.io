...
function countDown(second,endMinute,endHour,endDay,endMonth,endYear) {
    ...
    var interval = setInterval(function() { //запускаем таймер с интервалом 1 секунду
        ...
        if (time < 0) {                      //если конечная дата меньше текущей
            ...
            var end='</span>';
            var hLabel = '</span> <span class="label"><span class="for990">ชั่วโมง</span><span class="for320">ชั่วโมง</span><span class="for640">ชั่วโมง</span></span>';
            var mLabel = '</span> <span class="label"><span class="for990">นาที</span><span class="for320">นาที</span><span class="for640">นาที</span></span>';
            var sLabel = '</span> <span class="label"><span class="for990">วินาที</span><span class="for320">วินาที</span><span class="for640">วินาที</span></span';
...
countDown(5700); //устанавливаем таймер на прмерно 1 день